git clone https://github.com/ryjohnson92/Containers.git /var/lib/python/modules/Containers && \
    ...
    git clone https://github.com/ryjohnson92/Web.git /var/lib/python/modules/Web && \
    git clone https://github.com/ryjohnson92/pytools.git /var/lib/python/modules/PyTools;
